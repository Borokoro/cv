...
abstract class StyleConstants {
  static const EdgeInsets edgeInsetsH60V20 = EdgeInsets.symmetric(horizontal: 60, vertical: 20);
  static const EdgeInsets edgeInsets5 = EdgeInsets.all(5);
  ...
  static const EdgeInsets edgeInsetsB80 = EdgeInsets.only(bottom: 80);
  static const EdgeInsets edgeInsetsT80 = EdgeInsets.only(top: 80);
}